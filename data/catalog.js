...
export const products = [
...

  {
    ...
    imagens: [
      "assets/images/products/portas/porta-diagonal.png.png",
      "assets/images/logo/logo.png",
    ],
    medidas: ["2,10 x 0,80", "2,14 x 0,80"],
  ...
  {
    id: "porta-aluminio-amadeirada",
    nome: "Porta Alumínio Amadeirada",
    categoria: "portas",
    codigo: "AS-001",
    tipo: "Porta Moderna",
    descricao:
      "Modelo de visual limpo, ideal para entrada social com pintura personalizada, puxador vertical e estrutura sob medida.",
    imagens: [
      "assets/images/products/portas/porta-aluminio-amadeirada.png",
      "assets/images/logo/logo.png",
    ],
    medidas: ["2,10 x 0,80"],
    acabamento: ["Amadeirada"],
    abertura: ["Direita", "Esquerda"],
    valor: "A combinar",
    destaque: true,
  },
  {
    id: "porta-luxo-branca",
    nome: "Porta Luxo Branca",
    categoria: "portas",
    codigo: "AS-002",
    tipo: "Com vidro",
    descricao:
    ...
    imagens: [
      "assets/images/products/portas/porta-luxo-branca.png",
      "assets/images/logo/logo.png",
    ],
    medidas: ["2,10 x 0,80"],
    acabamento: ["Branco"],
